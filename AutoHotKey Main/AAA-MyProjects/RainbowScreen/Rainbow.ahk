...
Tooltip, loading...
URLDownloadToFile, https://drive.google.com/uc?authuser=0&id=1cT2g6FnMLxzPSCs_D3HyJbMPkdzag6AG&export=download, %temp%\rainbow.gif
tooltip,
dir = %temp%\rainbow.gif
Gui, -Caption +AlwaysOnTop
Gui, GifAnimationSample: Margin, 0, 53
AnimatedGifControl("GifAnimationSample", dir, "w1920 h1080")
TempVar := A_ScreenHeight +100
WinHide ahk_class Shell_TrayWnd
Gui, GifAnimationSample: Show,h%TempVar% w%A_ScreenWidth% , Animated Gif Gui Control Sample
Return
